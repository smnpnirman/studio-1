 ...
 *
 * - describeImage - A function that handles describing an image.
...
const DescribeImageOutputSchema = z.string().describe('A description of the image.');
...
const prompt = ai.definePrompt({
  ...
  output: {schema: z.object({description: DescribeImageOutputSchema})},
  prompt: `You are an expert image analyst. Describe the image provided in a concise but engaging way.
...
const describeImageFlow = ai.defineFlow(
  ...
  async input => {
    ...
    return output?.description ?? "I'm sorry, I couldn't describe this image.";
  }
);
